...
AARCH64_PATH 			?= $(TOOLCHAIN_ROOT)/aarch64
# The cross compiler prefix is actually aarch64-none-elf- but "make toolchains" has created symlinks
AARCH64_CROSS_COMPILE 		?= $(AARCH64_PATH)/bin/aarch64-linux-gnu-
AARCH64_GCC_VERSION 		?= arm-gnu-toolchain-11.3.rel1-aarch64-aarch64-none-elf
SRC_AARCH64_GCC 		?= https://developer.arm.com/-/media/Files/downloads/gnu/11.3.rel1/binrel/$(AARCH64_GCC_VERSION).tar.xz
...
aarch64-toolchain:
	$(call dltc,$(AARCH64_PATH),$(SRC_AARCH64_GCC),$(AARCH64_GCC_VERSION))
	cd $(AARCH64_PATH)/bin && for f in aarch64-none-elf-*; do ln -s $$f $$(echo $$f | sed s/aarch64-none-elf/aarch64-linux-gnu/); done
